...
export const projects: Project[] = [
  ...
  },
  {
    ...
    process:
      'El flujo depende del entregable. Para reels de paid media: el brief entra a Claude Code y sale una composición Remotion completa con timing, motion type y estructura de cortes. El humano revisa, selecciona y renderiza el final en After Effects. Para imagen generativa: prompt engineering en Gemini y ChatGPT con referencias de marca y restricciones de identidad, sin locación ni sesión fotográfica. Para video generativo: dirección de arte en Gemini Flow e Higgsfield desde el prompt inicial hasta las correcciones de actuación, y montaje final en AE. Para diseño automatizado: Codex genera los componentes visuales de un carrusel desde el brief; un script de Photoshop adapta el flyer aprobado a cinco formatos en un clic.',
    result:
