...
export const projectTranslationsEN: Record<string, ProjectTranslation> = {
  ...
  bwl: {
    ...
    result:
      '20+ pieces across static paid media, bilingual reels and editorial posts. A production system that allows adapting each piece to two languages without losing brand coherence. May 1 · Global Love Your Skin Month campaign: 53 likes and 43 sends — high send ratio for editorial content.',
    campaigns: [
      {
  ...
  'corazon-mixteco': {
    ...
    result:
      'Continuous production: editorial grids for February and March 2026, two educational carousels, four March reels and a roll-up banner for the point of sale.',
    campaigns: [
      {
        name: 'Educational Carousels',
        objective:
          'Product carousels that educate consumers on the authenticity and care of artisanal cheese — two formats: identifying artisanal cheese and preservation tips.',
  ...
  amorcito: {
    ...
    tags: ['Social Media', 'Art Direction', 'Campaigns', 'Print', 'Point of Sale', 'Generative AI'],
    overview:
    ...
    role: 'Art direction and content production: monthly grid, activation campaigns, multi-format adaptation (feed, stories, HD, print) and POS material design.',
    challenge:
    ...
    process:
      'Art direction starts with the space: warm lighting, yellow neon, wood and ceramic pieces. Editorial photography anchors each monthly grid, and from there campaign pieces, printed materials and activation kits are built — adapted to each format and location.',
    result:
      "Continuous production: monthly grids for Feb and March 2026, Valentine's Day campaign adapted for digital and print, a five-location kit in post + story format, a cocktail tent card and an expansion survey.",
    campaigns: [
      {
